...
public class EDS_QM_Terry : MonoBehaviour
{
    public List<EDS_QnA_Terry> QnA;
    ...
    void SetAnswer()
    {
        ...
        {
            options[i].GetComponent<Image>().color = options[i].GetComponent<EDS_AnswerScript_Terry>().startColor;
            options[i].GetComponent<EDS_AnswerScript_Terry>().isCorrect = false;
            ...
            {
                options[i].GetComponent<Image>().color = options[i].GetComponent<EDS_AnswerScript_Terry>().greenColor;
                options[i].GetComponent<EDS_AnswerScript_Terry>().isCorrect = true;
            }        
        }
    }
